...
const features = [
  {
    ...
    description: "Acompanhe suas receitas e despesas em tempo real com gráficos e relatórios detalhados.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Planejamento",
    description: "Crie metas financeiras e acompanhe seu progresso com ferramentas intuitivas.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">

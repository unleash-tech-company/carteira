...
export function TypographyH1(props: any) {
  return (
    <h1 className={cn("scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl", props.className)}>
      {props.children}
    </h1>
  )
}
export function TypographyH2(props: any) {
  return (
    <h2 className={cn("scroll-m-20 pb-2 text-2xl font-semibold tracking-tight first:mt-0", props.className)}>
      {props.children}
    </h2>
  )
}
...
export function TypographyH3(props: any) {
  return <h3 className={cn("scroll-m-20 text-xl font-semibold tracking-tight", props.className)}>{props.children}</h3>
}

export function TypographyH4(props: any) {
  return <h4 className={cn("scroll-m-20 text-lg font-semibold tracking-tight", props.className)}>{props.children}</h4>
}

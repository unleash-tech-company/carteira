        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/features/sharing" className="text-sm hover:text-white">
                  __Compartilhamento__
                </Link>
              </li>
              <li>
                <Link to="/features/security" className="text-sm hover:text-white">
                  __Segurança__
                </Link>
              </li>
              <li>
                <Link to="/features/payments" className="text-sm hover:text-white">
                  __Pagamentos__
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/feedback" className="text-sm hover:text-white">
                  __Feedback__
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/security-policy" className="text-sm hover:text-white">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link to="https://twitter.com/carteira" className="text-sm hover:text-white">
                __Twitter__
              </Link>
              <Link to="https://linkedin.com/company/carteira" className="text-sm hover:text-white">
                __LinkedIn__
              </Link>
              <Link to="https://github.com/carteira" className="text-sm hover:text-white">
                __GitHub__
              </Link>
            </div>
          </div>
